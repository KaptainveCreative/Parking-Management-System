...
<div class="sign-up-form">
    ...
    <input  class="input-box" type="text" name="lastName" id="lastNameId"  value="${form.lastName}" placeholder="Your Last Name ">
    ...
    <input  class="input-box" type="paymentMethod" name="paymentMethod" id="paymentMethodId" value="${form.paymentMethod}" placeholder=" Your Payment Method ">
    ...
    <input  class="input-box" type="phoneNumber" name="phoneNumber" id="phoneNumberId" value="${form.phoneNumber}" placeholder=" Your Phone Number ">
